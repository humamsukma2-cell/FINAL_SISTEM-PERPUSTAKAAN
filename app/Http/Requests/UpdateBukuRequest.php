    ...
    public function withValidator($validator): void
    {
        $validator->after(function ($validator) {
            if ($this->kategori == 'Programming' && $this->bahasa != 'Inggris') {
                $validator->errors()->add('bahasa', 'Jika kategori Programming, harus menggunakan bahasa Inggris.');
            }

            if ($this->tahun_terbit < 2000 && $this->stok > 5) {
                $validator->errors()->add('stok', 'Jika tahun terbit kurang dari 2000, stok maksimal 5.');
            }
        });
    }
}
