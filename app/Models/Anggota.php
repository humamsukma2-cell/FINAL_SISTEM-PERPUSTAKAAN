...
class Anggota extends Model
{
    ...
    /**
     * Accessor untuk menampilkan status anggota dalam bentuk badge Bootstrap.
     */
    ...
    /**
     * Accessor untuk menentukan kategori usia anggota.
     */
    ...
    /**
     * Scope untuk filter anggota berdasarkan jenis kelamin.
     */
    ...
    /**
     * Scope untuk mengambil anggota yang terdaftar pada bulan ini.
     */
    public function scopeTerdaftarBulanIni($query)
    {
        return $query->whereMonth('tanggal_daftar', date('m'))
            ->whereYear('tanggal_daftar', date('Y'));
    }

    /**
     * Relationship untuk mengambil transaksi yang terkait dengan anggota ini.
     */
