...
class TransaksiController extends Controller
{
    ...
    public function show(string $id)
    {
        ...
        if ($transaksi->status == 'Dipinjam') {
            $totalDenda = $this->hitungDenda($transaksi, now());
        } else {
            $totalDenda = $transaksi->denda;
        }

        return view('transaksi.show', compact('transaksi', 'totalDenda'));
    }
    ...
    {
        $tanggalKembali = $transaksi->tanggal_kembali->copy()->startOfDay();
